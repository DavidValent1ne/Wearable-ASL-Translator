...
def detect_letter():
    ...
    # A — all fingers bent, thumb straight alongside (no touches)
    # thumb above S threshold
    if fx['thumb'] > 1350 and i and m and r and p and not ti and not tm and not tr and not tp:
        return 'A'

    # S — all fingers bent, thumb bent over (no touches)
    # thumb below A threshold
    ...
    # use C thresholds — all fingers in partial range
    if (fx['thumb']  < FLEX_THRESH['thumb']  + 100 and
    ...
    # G — index straight, thumb straight, rest bent
    if not t and not i and m and r and p and not ti:
        return 'G'

    # L — thumb straight, index straight, rest bent
